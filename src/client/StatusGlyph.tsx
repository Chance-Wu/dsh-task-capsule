...
export function StatusGlyph({ status }: { status: CapsuleStatus }) {
  switch (status) {
    case 'running':
      return (
        <span className={`${css.glyph} ${css.glyphRunning}`} aria-hidden>
          <span className={css.glyphDot} />
        </span>
      )
    case 'waiting':
      return (
        <span className={`${css.glyph} ${css.glyphWaiting}`} aria-hidden>
          <span className={css.glyphDot} />
        </span>
      )
    case 'paused':
      return (
        <span className={`${css.glyph} ${css.glyphPaused}`} aria-hidden>
    ...
    case 'turnGap':
      ...
      return (
        <span className={`${css.glyph} ${css.glyphTurnGap}`} aria-hidden>
          <span className={css.pauseBar} />
          <span className={css.pauseBar} />
        </span>
      )
    case 'success':
      return (
        <span className={`${css.glyph} ${css.glyphSuccess}`} aria-hidden>
    ...
    case 'failed':
      return (
        <span className={`${css.glyph} ${css.glyphFailed}`} aria-hidden>
          <svg width={12} height={12} viewBox="0 0 12 12" fill="none">
    ...
    default:
      return (
        <span className={`${css.glyph} ${css.glyphPending}`} aria-hidden>
